...
<div class="flex items-center">
    ...
    <p class="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400">{{ product.rating.rate }}</p>
</div>
        ...
        <button class="group mx-auto mb-2 flex h-10 w-10/12 items-stretch overflow-hidden rounded-md text-gray-600">
          ...
          <div class="flex w-full items-center justify-center bg-green-300 text-l uppercase transition group-hover:bg-emerald-900 group-hover:text-white font-extrabold"> DETAIL PRODUCT</div>
        </router-link>
        </button> 
      </article>
