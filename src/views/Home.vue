                ...
                <div class="col">
                    ...
                    <div class="flex-auto p-6">
                        ...
                        <div class="mb-4">
                            ...
                            class="block appearance-none w-ful py-1 px-2 mb-1 text-base leading-normal bg-white text-gray-800 border border-gray-200 rounded">
                        </div>
                        <div class="mb-4">
                            <button
                            class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded no-underline bg-blue-600 text-white hover:bg-blue-600 py-1 px-1 leading-tight text-xs"
